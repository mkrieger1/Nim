...
var NTI520093722 = {size: 0,kind: 31,base: null,node: null,finalizer: null};
var NTI520093731 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI520093731 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a", len: 0, typ: NTI520093722, name: "a", sons: null}, 
{kind: 1, offset: "b", len: 0, typ: NTI33554456, name: "b", sons: null}]};
NTI520093731.node = NNI520093731;
...
framePtr = F;
framePtr = F.prev;
function contains_503316519(pattern_503316520, self_503316521) {
  ...
  framePtr = F;
    F.line = 52;
    result_503316522 = self_503316521.test(pattern_503316520);
  framePtr = F.prev;
...
framePtr = F;
F.line = 7;
var jsregex_486539265 = new RegExp("bc$", "i");
if (!(contains_503316519("abc", jsregex_486539265))) {
F.line = 8;
...
if (!(!(contains_503316519("abcd", jsregex_486539265)))) {
F.line = 9;
...
if (!(contains_503316519("xabc", jsregex_486539265))) {
F.line = 10;
...
function HEX2EHEX2E_520093729(a_520093732, b_520093733) {
  ...
  framePtr = F;
    F.line = 511;
    result_520093736 = nimCopy(result_520093736, {a: a_520093732, b: b_520093733}, NTI520093731);
  framePtr = F.prev;
...
function HEX3DHEX3D_520093707(x_520093709, y_520093710) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      ...
      var i_520093765 = 0;
      F.line = 126;
      var colontmp__520093796 = ({a: 0, b: 0});
      F.line = 308;
      colontmp__520093796 = nimCopy(colontmp__520093796, HEX2EHEX2E_520093729(0, subInt((x_520093709).length, 1)), NTI520093731);
      L2: do {
        F.line = 129;
        var x_520093802 = 0;
        F.line = 90;
        var res_520093803 = colontmp__520093796.a;
        L3: do {
          F.line = 91;
            L4: while (true) {
            if (!(res_520093803 <= colontmp__520093796.b)) break L4;
              F.line = 129;
              x_520093802 = res_520093803;
              F.line = 308;
              i_520093765 = x_520093802;
              ...
              F.line = 93;
              res_520093803 = addInt(res_520093803, 1);
            }
        } while(false);
      } while(false);
    } while(false);
...
function HEX24_503316511(self_503316512) {
  var result_503316513 = [];

  var F={procname:"jsre.$",prev:framePtr,filename:"/home/runner/work/Nim/Nim/lib/js/jsre.nim",line:0};
  framePtr = F;
    F.line = 39;
    result_503316513 = nimCopy(null, cstrToNimstr(self_503316512.toString()), NTI33554439);
  framePtr = F.prev;
...
framePtr = F;
F.line = 7;
var jsregex_520093697 = new RegExp("\\s+", "i");
F.line = 8;
jsregex_520093697.compile("\\w+", "i");
if (!(contains_503316519("nim javascript", jsregex_520093697))) {
F.line = 9;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples2.nim(9, 8) `\"nim javascript\".contains jsregex` "));
}

if (!(HEX3DHEX3D_520093707(jsregex_520093697.exec("nim javascript"), ["nim"]))) {
F.line = 10;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples2.nim(10, 8) `jsregex.exec(r\"nim javascript\") == @[\"nim\".cstring]` "));
}

if (!((jsregex_520093697.toString() == "/\\w+/i"))) {
F.line = 11;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples2.nim(11, 8) `jsregex.toCstring() == r\"/\\w+/i\"` "));
}

F.line = 12;
jsregex_520093697.compile("[0-9]", "i");
if (!(contains_503316519("0123456789abcd", jsregex_520093697))) {
F.line = 13;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples2.nim(13, 8) `\"0123456789abcd\".contains jsregex` "));
}

if (!(eqStrings(HEX24_503316511(jsregex_520093697), makeNimstrLit("/[0-9]/i")))) {
F.line = 14;
failedAssertImpl_218103865(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples2.nim(14, 8) `$jsregex == \"/[0-9]/i\"` "));
}
