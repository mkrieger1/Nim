...
function auxWriteStackTrace_33556531(f_33556532) {
  ...
  var result_33556533 = [[]];
    ...
    L6: do {
      ...
      colontmp__486539298 = (i_33556542 - 1);
      var res_486539300 = colontmp__486539298;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_486539300)) break L8;
            j_33556590 = res_486539300;
...
framePtr = F;
F.line = 7;
var data_486539265 = new FormData();
F.line = 8;
data_486539265.set("key0", "value0");
F.line = 9;
data_486539265.append("key1", "value1");
F.line = 10;
data_486539265.delete("key1");
if (!(data_486539265.has("key0"))) {
F.line = 11;
...
if (!((data_486539265.get("key0") == "value0"))) {
F.line = 12;
...
F.line = 13;
(() => { const frmdt = data_486539265; Array.from(frmdt.keys()).forEach((key) => frmdt.delete(key)) })();
if (!((Array.from(data_486539265.entries()).length == 0))) {
F.line = 14;
